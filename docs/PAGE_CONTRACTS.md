...
- **Tasks.** Tasks with Control Atlas working files name their companion templates, and every template is reachable from at least one task. `tests/template-wave3.test.mjs` checks this.
